...
|-----|--------------------------------------|---------------|
| PDM | Programação para dispositivos móveis | 60h           |
| PIN | Projeto Integrador II                | 60h           |
| POO | Programação Orientada a Objetos II   | 80h           |
| PRW | Programação Web II                   | 80h           |
| SWE | Serviços Web                         | 40h           |
| TOP | Tópicos Especiais em D. de Sistemas  | 40h           |
| TSO | Teste de Software                    | 40h          |
...
- DAMINELLI, Herval. [Lista de exercícios]. Material didático da disciplina Programação Web II. Instituto Federal de Santa Catarina (IFSC), 2026.
- PISCHING, Marcos Andre. [Lista de exercícios]. Material didático da disciplina Programação Orientada a Objetos II. Instituto Federal de Santa Catarina (IFSC), 2026.
- BUENO, Lucas. [Lista de exercícios]. Material didático da disciplina Serviços Web. Instituto Federal de Santa Catarina (IFSC), 2026.
- VELLOSO, Bruno Panerai. [Lista de exercícios]. Material didático da disciplina Programção para Dispositivos Móveis. Instituto Federal de Santa Catarina (IFSC), 2026.
- CARDOZO, Glauco. [Lista de exercícios]. Material didático da disciplina Tópicos Especiais em D. de Sistemas. Instituto Federal de Santa Catarina (IFSC), 2026.
- CORREA, Underlea Cabreira. [Lista de exercícios]. Material didático da disciplina Teste de Software. Instituto Federal de Santa Catarina (IFSC), 2026.